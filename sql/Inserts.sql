insert into statuses values ( 'Abandoned' );
insert into statuses values ( 'In Development' );
insert into statuses values ( 'Operational' );
insert into statuses values ( 'Prototype' );
insert into statuses values ( 'Retired' );

insert into regions values ( 'Africa' );
...
insert into regions values ( 'Oceania' );
insert into regions values ( 'Antarctica' );

insert into classes values ( 'Air Superiority Fighter' );
insert into classes values ( 'All Weather Interceptor' );
insert into classes values ( 'Amphibious Fighter' );
insert into classes values ( 'Cannon Fighter' );
insert into classes values ( 'Carrier Fighter' );
insert into classes values ( 'Carrier Fighter Bomber' );
insert into classes values ( 'Carrier Heavy Fighter' );
insert into classes values ( 'Carrier Interceptor' );
insert into classes values ( 'Carrier Jet Fighter' );
insert into classes values ( 'Carrier Mixed Propulsion Fighter' );
insert into classes values ( 'Carrier Multirole Fighter' );
insert into classes values ( 'Carrier Night Fighter' );
insert into classes values ( 'Carrier Strike Fighter' );
insert into classes values ( 'Carrier VSTOL Fighter' );
insert into classes values ( 'Carrier VTOL Fighter' );
insert into classes values ( 'Day Night Fighter' );
insert into classes values ( 'Emergency Fighter Trainer' );
insert into classes values ( 'Escort Fighter' );
insert into classes values ( 'Experimental Fighter' );
insert into classes values ( 'Fighter' );
insert into classes values ( 'Fighter Bomber' );
insert into classes values ( 'Fighter Bomber Jet' );
insert into classes values ( 'Fighter Bomber Jet Flying Wing' );
insert into classes values ( 'Fighter Bomber Night Fighter' );
insert into classes values ( 'Fighter Interceptor' );
insert into classes values ( 'Fighter Reconnaissance' );
insert into classes values ( 'Fighter Dive Bomber' );
insert into classes values ( 'Fleet Fighter' );
insert into classes values ( 'Fleet Fighter Reconnaissance' );
insert into classes values ( 'Floatplane Fighter' );
insert into classes values ( 'Flying Boat Fighter' );
insert into classes values ( 'Flying Boat Jet Fighter' );
insert into classes values ( 'Heavy Cannon Fighter' );
insert into classes values ( 'Heavy Fighter' );
insert into classes values ( 'High Altitude Interceptor' );
insert into classes values ( 'High Altitude Fighter' );
insert into classes values ( 'Interceptor' );
insert into classes values ( 'Interceptor Glider' );
insert into classes values ( 'Interceptor Rocket' );
insert into classes values ( 'Interceptor Mixed Propulsion' );
insert into classes values ( 'Interceptor Fighter Bomber' );
insert into classes values ( 'Interceptor Fleet Fighter' );
insert into classes values ( 'Interceptor Ground Attack' );
insert into classes values ( 'Jet' );
insert into classes values ( 'Light Combat' );
insert into classes values ( 'Lightweight Fighter' );
insert into classes values ( 'Lightweight Fighter Bomber' );
insert into classes values ( 'Lightweight Jockey Fighter' );
insert into classes values ( 'Long Range Fighter' );
insert into classes values ( 'Maritime Patrol' );
insert into classes values ( 'Mixed Power' );
insert into classes values ( 'Multirole Air Superiority Fighter' );
insert into classes values ( 'Multirole Fighter' );
insert into classes values ( 'Multirole Strike Fighter' );
insert into classes values ( 'Night Fighter' );
insert into classes values ( 'Parasite Fighter' );
insert into classes values ( 'Planned Carrier Fighter' );
insert into classes values ( 'Polymorphic Fighter' );
insert into classes values ( 'Shipboard Fighter' );
insert into classes values ( 'Speed Scout Pursuit' );
insert into classes values ( 'Stealth Fighter' );
insert into classes values ( 'Stealth Multirole Fighter' );
insert into classes values ( 'Strike Fighter' );
insert into classes values ( 'Technology Demonstrator' );
insert into classes values ( 'Torpedo Fighter' );
insert into classes values ( 'Torpedo Strike Fighter' );
insert into classes values ( 'Turret Fighter' );
insert into classes values ( 'Twin Engine Fighter' );
insert into classes values ( 'Two Seat Fighter' );
insert into classes values ( 'Unmanned Fighter' );
insert into classes values ( 'VSTOL Fighter Bomber' );
insert into classes values ( 'VTO Rocket Interceptor' );
...
insert into countries values ( 'Zimbabwe',
                               'Africa' );
insert into countries values ( 'Czechoslovakia',
                               'Europe' );
insert into countries values ( 'Austria-Hungary',
                               'Europe' );
insert into countries values ( 'USSR',
                               'Asia' );
insert into countries values ( 'Yugoslavia',
                               'Europe' );
insert into countries values ( 'West Germany',
                               'Europe' );